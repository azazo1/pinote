...
双击便签顶栏可收起或展开, 拖动顶栏可移动窗口. 浮动便签接近其他便签或当前屏幕边缘时会自动对齐并贴靠, 鼠标靠近侧边球时会缩向球心预览, 松手后确认收纳. 在 macOS 全屏空间中, 便签以辅助窗口共存, 不会挤压全屏应用. 每张便签可以独立收纳到侧边, 直接拖动侧边架中的便签条即可从球中展开并移出. 半圆把手可以沿屏幕右侧拖动并按显示器记住位置, 鼠标离开把手和展开便签后会短暂延迟再收回.
