...
contextBridge.exposeInMainWorld("noteAPI", {
  ...
  beginShelfNoteDrag: (id, pointerX, pointerY) => ipcRenderer.send("shelf:note-drag-start", id, pointerX, pointerY),
  moveShelfNoteDrag: (id, pointerX, pointerY) => ipcRenderer.send("shelf:note-drag", id, pointerX, pointerY),
